...
var translations = map[string]map[string]string{
	...
	"admin.smtp_host":      {"es": "Servidor SMTP", "en": "SMTP Host"},
	"admin.smtp_port":      {"es": "Puerto", "en": "Port"},
	"admin.smtp_user":      {"es": "Usuario", "en": "Username"},
	"admin.smtp_password":  {"es": "Contraseña", "en": "Password"},
	"admin.smtp_from":      {"es": "Remitente", "en": "From address"},
